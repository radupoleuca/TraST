...
<body>
   ...
   <div class="titlu">
    ...
    <div class="spatiu_text1">
        <img src="temporare/1.png" class="img" alt="Imagine">
        
        <p class="p1">Drum ingustat pe partea dreapta</p>
    
       </div>
       <div class="spatiu_text2">
        <img src="temporare/2.png" class="img2" alt="Imagine">
        
        <p class="p2">Acostament periculos</p>
       </div>
    
       <div class="spatiu_text1">
        <img src="temporare/3.png" class="img" alt="Imagine">
        
        <p class="p1">Semafoare</p>
       </div>
       <div class="spatiu_text2">
        <img src="temporare/4.png" class="img2" alt="Imagine">
        
        <p class="p2">Alte pericole</p>
       </div>
    
       <div class="spatiu_text1">
        <img src="temporare/5.png" class="img" alt="Imagine">
        
        <p class="p1">Limitare de viteza</p>
       </div>
       <div class="spatiu_text2">
        <img src="temporare/6.png" class="img2" alt="Imagine">
        
        <p class="p2">Sfarsitul interzicerii de a depasi</p>
       </div>
    
       <div class="spatiu_text1">
        <img src="temporare/7.png" class="img" alt="Imagine">
        
        <p class="p1">Deviere temporara</p>
       </div>
       <div class="spatiu_text2">
        <img src="temporare/8.png" class="img2" alt="Imagine">
        
        <p class="p2">Ingustare temporara</p>
       </div>
    
       <div class="spatiu_text1">
        <img src="temporare/9.png" class="img" alt="Imagine">
        
        <p class="p1">Abatere temporara</p>
       </div>
       <div class="spatiu_text2">
        <img src="temporare/10.png" class="img2" alt="Imagine">
        
        <p class="p2">Abatere temporara</p>
       </div>
    
       <div class="spatiu_text1">
        <img src="temporare/11.png" class="img" alt="Imagine">
        
        <p class="p1">Marcaje rutiere</p>
       </div>
       <div class="spatiu_text2">
        <img src="temporare/12.png" class="img2" alt="Imagine">
        
        <p class="p2">Lucrari de tratamente ale suprafetei partii carosabile</p>
       </div>
    
       <div class="spatiu_text1">
        <img src="temporare/13.png" class="img" alt="Imagine">
